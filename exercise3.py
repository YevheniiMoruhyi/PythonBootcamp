...
eigrp_pattern = re.compile('^(D|E|R|EX)\s(((25[0-5]|2[0-4]\d|1\d\d|[1-9]\d|\d)\.){3}(25[0-5]|2[0-4]\d|1\d\d|[1-9]\d|\d))\s(\[.*\])\svia\s(((25[0-5]|2[0-4]\d|1\d\d|[1-9]\d|\d)\.){3}(25[0-5]|2[0-4]\d|1\d\d|[1-9]\d|\d))\,\s(\d:\d{2}:\d{2})\,\s(.*)$')
